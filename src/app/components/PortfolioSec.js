  ...
  return (
    <div className='w-full flex flex-col items-center justify-center my-14 gap-y-4' id='portfolio'>
        ...
        {data.image.map((elem,index)=>(
            <div key={index} className='cursor-pointer max-w-[500px] w-full h-[530px] bg-no-repeat bg-cover bg-center lg:my-4 my-2' style={{backgroundImage: elem.img}}>
            <div className='opacity-0 hover:opacity-70 bg-white/100 w-full h-full pt-10'>
